...
import dev.everydaythings.graph.library_old.mapdb.MapDBItemDirectory;
import dev.everydaythings.graph.library_old.mapdb.MapDBItemStore;
import dev.everydaythings.graph.library_old.mapdb.MapDBLibraryIndex;
import dev.everydaythings.graph.library_old.mapdb.MapDBTokenDictionary;
import dev.everydaythings.graph.library_old.rocksdb.RocksItemDirectory;
import dev.everydaythings.graph.library_old.rocksdb.RocksItemStore;
import dev.everydaythings.graph.library_old.rocksdb.RocksLibraryIndex;
import dev.everydaythings.graph.library_old.rocksdb.RocksTokenDictionary;
import dev.everydaythings.graph.library_old.skiplist.SkipListItemDirectory;
import dev.everydaythings.graph.library_old.skiplist.SkipListItemStore;
import dev.everydaythings.graph.library_old.skiplist.SkipListLibraryIndex;
import dev.everydaythings.graph.library_old.skiplist.SkipListTokenDictionary;
...
public final class LibraryOld implements Canonical, AutoCloseable {
    ...
    public ContentID storeFrame(
        ...
        byte[] recordBytes = record.encodeBinary(Canonical.Scope.RECORD);
