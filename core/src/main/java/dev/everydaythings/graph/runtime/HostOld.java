 ...
 * </ul>
 */
@Implements(HostOld.KEY)
@ItemSeed(key = HostOld.KEY)
public class HostOld extends SignerOld {
    ...
    protected HostOld(ItemID typeId) {
        super(typeId);
    }
