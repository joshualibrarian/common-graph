...
@Seed.Item(key = LessThan.KEY, head = dev.everydaythings.graph.item.Item.Predicate.KEY)
@Seed.Embodies(key = LessThan.KEY)
public class LessThan extends Item {
    ...
    public Object applyBinary(Object left, Object right) {
        ...
        throw new IllegalArgumentException(
                "LessThan.applyBinary: unsupported operand types " + left + " < " + right);
    }
}
