...
@Seed.Item(key = LessOrEqual.KEY, head = dev.everydaythings.graph.item.Item.Predicate.KEY)
@Seed.Embodies(key = LessOrEqual.KEY)
public class LessOrEqual extends Item {
    ...
    public Object applyBinary(Object left, Object right) {
        ...
        throw new IllegalArgumentException(
                "LessOrEqual.applyBinary: unsupported operand types " + left + " <= " + right);
    }
}
