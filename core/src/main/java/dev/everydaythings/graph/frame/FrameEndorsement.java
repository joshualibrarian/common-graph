 ...
 *
 * <p>The frame body itself ({@link FrameBodyOld}) carries the semantic
...
public final class FrameEndorsement implements Canonical {
    ...
    public FrameEndorsement(CompoundKey key, ContentID bodyHash, List<Mount> mounts) {
        this.key = Objects.requireNonNull(key, "key");
        this.bodyHash = Objects.requireNonNull(bodyHash, "bodyHash");
        this.mounts = mounts != null ? List.copyOf(mounts) : List.of();
    }

    public FrameEndorsement(CompoundKey key, ContentID bodyHash) {
     ...
     */
    public static FrameEndorsement of(CompoundKey key, FrameBodyOld body, List<Mount> mounts) {
     ...
     */
    public static FrameEndorsement of(CompoundKey key, FrameBodyOld body) {
