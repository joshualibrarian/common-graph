 ...
 *
 * <p>A FrameRecord wraps a {@link FrameBodyOld} hash with signer identity,
 ...
 */
@Getter
public final class FrameRecordOld implements Signing.Target {
     ...
     */
    public FrameRecordOld(ContentID bodyHash, SigningPublicKey signer, Instant timestamp) {
     ...
     */
    public FrameRecordOld sign(SignerOld signer) {
     ...
     */
    public static FrameRecordOld create(FrameBodyOld body, SignerOld signer) {
        Objects.requireNonNull(body, "body");
        Objects.requireNonNull(signer, "signer");
        FrameRecordOld record = new FrameRecordOld(body.hash(), signer.publicKey(), Instant.now());
        record.sign(signer);
        return record;
    }
     ...
     */
    public static FrameRecordOld unsigned(FrameBodyOld body, SigningPublicKey signerKey) {
        Objects.requireNonNull(body, "body");
        Objects.requireNonNull(signerKey, "signerKey");
        return new FrameRecordOld(body.hash(), signerKey, Instant.now());
    }
     ...
     */
    public static FrameRecordOld decode(byte[] bytes) {
