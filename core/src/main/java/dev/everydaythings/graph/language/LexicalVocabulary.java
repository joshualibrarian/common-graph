...
public final class LexicalVocabulary {
    ...
    public static class Hypernym {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "hypernym");
    }
    ...
    public static class Hyponym {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69570")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "hyponym");
    }
    ...
    public static class InstanceOf {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i35284")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "instance-of");
    }
    ...
    public static class Holonym {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69567")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "holonym");
    }
    ...
    public static class Meronym {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69575")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "meronym");
    }
    ...
    public static class Antonym {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69547")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "antonym");
    }
    ...
    public static class SimilarTo {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i34992")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "similar-to");
    }
    ...
    public static class Derivation {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i37467")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "derivation");
    }
    ...
    public static class Domain {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i68336")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "domain");
    }
    ...
    public static class Entails {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i34848")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "entails");
    }
    ...
    public static class Causes {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i29966")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "causes");
    }
    ...
    public static class SeeAlso {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i25271")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "see-also");
    }
}
