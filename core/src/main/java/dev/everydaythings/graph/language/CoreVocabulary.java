...
public final class CoreVocabulary {
    ...
    public static class Create {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "create").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "new").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "make")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY)
    ...
    public static class Get {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "get").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "retrieve")
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "fetch").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "lookup")
    ...
    public static class Put {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "put").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "store")
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "add").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "insert")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY);
    }
    ...
    public static class Remove {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "remove").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "delete").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "drop")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class ListVerb {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "list").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "enumerate")
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "all").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "tail").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "latest")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Import {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "import").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "ingest").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "load")
                .slot(ThematicRole.Source.KEY);
    }
    ...
    public static class Query {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "query").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "search")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Find {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "find").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "lookup")
    ...
    public static class Help {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "help").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "assist").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "commands")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Edit {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "edit").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "modify").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "change")
    ...
    public static class Count {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "count").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "size")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Describe {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "describe").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "status").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "info")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Inspect {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "inspect").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "examine")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Cd {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "cd").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "go").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "enter")
    ...
    public static class Exit {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "exit").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "quit").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "q");
    }
    ...
    public static class Back {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .symbol("..").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "back").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "pop");
    }
    ...
    public static class Serve {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "serve").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "use")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Invite {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "invite")
                .slot(ThematicRole.Theme.KEY).slot(ThematicRole.Goal.KEY);
    }
    ...
    public static class Authenticate {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "authenticate").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "auth").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "login")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Switch {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "switch").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "as")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Rename {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "rename").word(PartOfSpeech.VERB, Sememe.LEMMA, Sememe.ENG, "name")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Slot {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69534")
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "slot")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class LexemeSeed {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .cili("i69622")
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "lexeme")
                .slot(ThematicRole.Referent.KEY);
    }
    ...
    public static class Frequency {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "frequency")
                .cili("i73785")
                .slot(ThematicRole.Topic.KEY);
    }
    ...
    public static class Provenance {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "provenance")
                .cili("i77490")
                .slot(ThematicRole.Source.KEY);
    }
    ...
    public static class Activity {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "activity")
                .slot(ThematicRole.Theme.KEY)
                .slot(ThematicRole.Topic.KEY)
                .cili("i30955");
    }
    ...
    public static class Library {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "library")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Vault {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "vault")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class KeyHistory {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "key history")
                .slot(ThematicRole.Theme.KEY)
                .slot(ThematicRole.Topic.KEY);
    }
    ...
    public static class CertHistory {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "cert history")
                .slot(ThematicRole.Theme.KEY)
                .slot(ThematicRole.Topic.KEY);
    }
    ...
    public static class HashKey {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "hash key")
                .slot(ThematicRole.Referent.KEY);
    }
    ...
    public static class LanguageCode {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "language code")
                .slot(ThematicRole.Referent.KEY);
    }
    ...
    public static class Canonicalization {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "canonicalization")
                .slot(ThematicRole.Topic.KEY);
    }
    ...
    public static class Monitor {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "monitor")
                .slot(ThematicRole.Theme.KEY);
    }
    ...
    public static class Symbol {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "symbol")
                .slot(ThematicRole.Referent.KEY);
    }
    ...
    public static class Facet {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "facet")
                .slot(ThematicRole.Topic.KEY);
    }
    ...
    public static class Stream {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "stream");
    }
    ...
    public static class External {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "external");
    }
    ...
    public static class Encrypted {
        ...
        @Seed public static final Sememe SEED = new Sememe(KEY)
                ...
                .word(PartOfSpeech.NOUN, Sememe.LEMMA, Sememe.ENG, "encrypted");
    }
