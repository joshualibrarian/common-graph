...
public class Seed {
     ...
     * to K's seed manifest; future {@code fetchItem(ItemRef.iid(K.KEY))} hydrates as an
     ...
     *
     * <pre>
     * IMPLEMENTS { THEME → ItemRef.iid(K.KEY), AGENT[runtime=java] → Literal.ofJavaClass(this) }
     * </pre>
     *
