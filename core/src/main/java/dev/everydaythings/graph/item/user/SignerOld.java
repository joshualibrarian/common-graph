 ...
 * }</pre>
 */
@Implements(SignerOld.KEY)
@ItemSeed(key = SignerOld.KEY)
public abstract class SignerOld extends ItemOld implements Signing.Signer {
    ...
    @ItemFrame(predicate = CoreVocabulary.Lexeme.KEY, fieldAs = @ItemFrame.Bind(role = ThematicRole.Value.KEY, qualifiers = {Language.ENGLISH_KEY, PartOfSpeech.Noun.KEY, GrammaticalFeature.Lemma.KEY}))
     ...
     */
    @ItemFrame(predicate = CoreVocabulary.Vault.KEY, endorsement = @ItemFrame.Endorsed(mounts = {".vault"}), localOnly = true)
     ...
     */
    @ItemFrame(predicate = CoreVocabulary.KeyHistory.KEY, endorsement = @ItemFrame.Endorsed(mounts = {".keys"}))
     ...
     */
    @ItemFrame(predicate = CoreVocabulary.CertHistory.KEY, endorsement = @ItemFrame.Endorsed(mounts = {".certs"}))
     ...
     */
    @ItemFrame(predicate = RoutingVocabulary.Name.KEY, endorsement = @ItemFrame.Endorsed(false))
    private String name;
     ...
     */
    protected SignerOld(ItemID iid) {
        super(iid);
    }
     ...
     */
    protected SignerOld(LibrarianOld librarian, ManifestOld manifest) {
     ...
     */
    protected SignerOld(LibrarianOld librarian, Path path, ItemStore fallbackStore) {
     ...
     */
    protected SignerOld(LibrarianOld librarian, ItemStore store) {
     ...
     */
    protected SignerOld(LibrarianOld librarian, ManifestOld manifest, SigningPublicKey publicKey) {
        super(librarian, manifest);
