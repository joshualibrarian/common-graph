...
class ExpectsFrameOldTest {
    ...
    void expects_framesAreMaterialized() {
        ItemOld item = SeedItemFactory.create(TestType.class);
        assertThat(item).isNotNull();

        List<FrameBodyOld> expectsBodies = expectsFrames(item);
    ...
    void expects_homeBindingIsThisType() {
        ...
        List<FrameBodyOld> expectsBodies = expectsFrames(item);
        for (FrameBodyOld body : expectsBodies) {
    ...
    void expects_qualifiersArePreserved() {
        ...
        ItemOld item = SeedItemFactory.create(GameType.class);
        assertThat(item).isNotNull();
    ...
    private static List<FrameBodyOld> expectsFrames(ItemOld item) {
    ...
    private static ItemID topicId(FrameBodyOld body) {
