...
@Tag("slow")
class ItemOldPolicyResolverTest {

    private static LibrarianOld lib;
    ...
    static void setupLibrarian() {
        lib = LibrarianOld.createInMemory();
    }

    @BeforeEach
    void setUp() {
        item = ItemOld.create(lib);
    ...
    private void addRosterWithMember(ItemID member) {
        ...
        CompoundKey key = CompoundKey.of(rosterPred);
