...
class FrameOldIndexTest {
    ...
    class IndexFrameOld {
        ...
        void multipleFrames() {
            FrameBodyOld body1 = FrameBodyOld.of(AUTHOR, THE_HOBBIT,
                    Map.of(GOAL_ROLE, BindingTarget.iid(TOLKIEN)));
            FrameBodyOld body2 = FrameBodyOld.of(LIKES, THE_HOBBIT,
    ...
    class RecordByBody {
        ...
        void attestationCount() {
            FrameBodyOld body = FrameBodyOld.of(LIKES, THE_HOBBIT,
                    Map.of(GOAL_ROLE, BindingTarget.iid(ALICE)));
            ContentID bodyHash = body.hash();
        ...
        void independentBodies() {
            FrameBodyOld body1 = FrameBodyOld.of(LIKES, THE_HOBBIT,
                    Map.of(GOAL_ROLE, BindingTarget.iid(ALICE)));
            FrameBodyOld body2 = FrameBodyOld.of(LIKES, THE_HOBBIT,
    ...
    class IndexEndorsedFrameOld {
        ...
        void semanticKeyIndexed() {
            ...
            FrameOld frame = FrameOld.snapshot(CompoundKey.of(TITLE),
        ...
        void literalKeyNotIndexed() {
            ...
            FrameOld frame = FrameOld.snapshot(CompoundKey.of(ItemID.fromString("cg.test:vault")),
        ...
        void referenceIndexed() {
            ...
            FrameOld frame = FrameOld.reference(CompoundKey.of(AUTHOR),
