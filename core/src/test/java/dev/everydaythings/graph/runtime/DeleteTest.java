...
class DeleteTest {
    ...
    class SelfAuthored {
        ...
        void removesRecords() {
            ...
            DatumRef manifestCid = lib.library().manifestCidsForItem(iid).getFirst();
            // Commit auto-produced a record for the manifest.
            List<DatumRef> recordCids = lib.library().recordCidsForBody(manifestCid);
    ...
    class LowLevelDelete {
        ...
        void deleteRecordTearsDown() {
            ...
            DatumRef manifestCid = lib.library().manifestCidsForItem(iid).getFirst();
            DatumRef recordCid = lib.library().recordCidsForBody(manifestCid).getFirst();
