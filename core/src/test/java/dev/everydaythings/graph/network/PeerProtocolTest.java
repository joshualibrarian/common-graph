...
/**
 * Integration test for PeerProtocol handshake over TLS.
 *
...
class PeerProtocolTest {
    ...
    void handshakeCreatesPeerRelationsOverTls() throws Exception {
        ...
        PeerProtocol proto1 = lib1.peerProtocol().orElseThrow();
        PeerProtocol proto2 = lib2.peerProtocol().orElseThrow();
        ...
        Literal endpointLit = (Literal) lib2ReachableBody.binding(
                dev.everydaythings.graph.language.ThematicRole.Goal.IID);
