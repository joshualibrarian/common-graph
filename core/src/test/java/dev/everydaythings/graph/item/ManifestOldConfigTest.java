...
class ManifestOldConfigTest {

    static final Binding TEST_IMPL = ManifestOld.javaImplementation(ItemOld.class);
    ...
    class BuilderAndAccessors {
        ...
        void noConfig() {
            ManifestOld m = ManifestOld.builder()
                    .iid(ItemID.random())
    ...
    class VidStability {
        ...
        void configDoesNotAffectVid() {
            ...
            ManifestOld without = ManifestOld.builder()
                    .iid(iid)
                    .implementation(TEST_IMPL)
                    .build();

            ManifestOld with = ManifestOld.builder()
                    .iid(iid)
                    .implementation(TEST_IMPL)
                    .binding(Binding.nonIdentity(
    ...
    class CborRoundTrip {
        ...
        void noConfigRoundTrip() {
            ManifestOld original = ManifestOld.builder()
                    .iid(ItemID.random())
                    .implementation(TEST_IMPL)
                    .build();

            byte[] bytes = original.encodeBinary(Canonical.Scope.RECORD);
            ManifestOld decoded = ManifestOld.decode(bytes);
