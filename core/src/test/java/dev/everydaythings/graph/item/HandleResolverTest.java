...
class HandleResolverTest {
    ...
    @Implements(TYPE_KEY)
    static class BookItem extends ItemOld {
        BookItem(LibrarianOld lib) { super(lib); }
    }
    ...
    void setUp() {
        ...
        ItemOld bookTypeSeed = SeedItemFactory.create(BookType.class);
    ...
    void resolve_returnsNullForItemWithoutType() {
        ItemOld plain = new ItemOld(librarian);
    ...
    void resolve_extractsFeatureFromMatchingFrame() {
        ...
        FrameBodyOld authorFrame = new FrameBodyOld(
    ...
    void resolve_respectsSalienceOrder() {
        ...
        FrameBodyOld titleFrame = new FrameBodyOld(
    ...
    void disambiguate_addsFeaturesUntilUnique() {
        ...
        // Both by Tolkien
        book1.endorseFrame(new FrameBodyOld(ItemID.fromString(AUTHOR_KEY), List.of(
                new Binding(ThematicRole.Theme.IID, BindingTarget.iid(book1.iid())),
                Binding.literal(ThematicRole.Agent.IID, Literal.ofText("Tolkien")))));
        book1.endorseFrame(new FrameBodyOld(ItemID.fromString(TITLE_KEY), List.of(
                new Binding(ThematicRole.Theme.IID, BindingTarget.iid(book1.iid())),
                Binding.literal(ThematicRole.Referent.IID, Literal.ofText("The Hobbit")))));

        book2.endorseFrame(new FrameBodyOld(ItemID.fromString(AUTHOR_KEY), List.of(
                new Binding(ThematicRole.Theme.IID, BindingTarget.iid(book2.iid())),
                Binding.literal(ThematicRole.Agent.IID, Literal.ofText("Tolkien")))));
        book2.endorseFrame(new FrameBodyOld(ItemID.fromString(TITLE_KEY), List.of(
                new Binding(ThematicRole.Theme.IID, BindingTarget.iid(book2.iid())),
    ...
    void fallback_prioritizesNameOverAgent() {
        ...
        item.endorseFrame(new FrameBodyOld(
