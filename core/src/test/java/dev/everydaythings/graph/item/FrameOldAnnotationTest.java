...
class FrameOldAnnotationTest {
    ...
    static class EndorsedFrameItem extends ItemOld {
    ...
    static class SemanticFrameItem extends ItemOld {
    ...
    static class UnendorsedFrameItem extends ItemOld {
    ...
    static class MixedFrameItem extends ItemOld {
