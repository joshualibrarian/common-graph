...
class FrameTargetTest {
    ...
    class Construction {
        ...
        void wrapsBody() {
            FrameBody inner = new FrameBody(ADD, ITEM_A);
    ...
    class CborRoundTrip {
        ...
        void nestedRoundTrip() {
            ...
            FrameBody nestedAdd = ((BindingTarget.FrameTarget) themeBind.target()).body();
    ...
    class Equality {
        ...
        void equalTargets() {
            FrameBody body1 = new FrameBody(ADD, ITEM_A);
            FrameBody body2 = new FrameBody(ADD, ITEM_A);
        ...
        void differentTargets() {
            var t1 = new BindingTarget.FrameTarget(new FrameBody(ADD, ITEM_A));
            var t2 = new BindingTarget.FrameTarget(new FrameBody(MUL, ITEM_A));
