 ...
 * @see MsdfAtlas
 */
public class LegacyFilamentSurfacePainter implements SurfacePainter {
    ...
    private static final Logger log = LogManager.getLogger(LegacyFilamentSurfacePainter.class);
    ...
    public LegacyFilamentSurfacePainter(Engine engine, Scene scene, MsdfFontManager fontManager) {
